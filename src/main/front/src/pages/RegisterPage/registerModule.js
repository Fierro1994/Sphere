...
const Register = () => {
    ...
    const onSubmit = (data) => {
        ...
        if (file){
            const filesub = base64ToFile(croppedImage, nameImg)
            formData.append("avatar", filesub)
        }
                ...
                <div className={style.cont}>
                    <div className={style.form_container}>
                        ...
                        {!file && <div className={style.avatar_change}>
                            <p>Загрузите вашу фотографию здесь: </p>
                            <label className={style.cont_av_img}> <MdOutlineAddAPhoto className={style.avatar_svg}/>
                                <input
                                    type="file"
                                    name="cover"
                        ...
                        <div>
                            ...
                            {auth.registerStatus === "pending" &&
                                <div style={{color: "white"}}>ожидайте регистрации..</div>}
                        </div>
                    </div>
                </div>
            </form>
