...
public class Gallery{
    ...
    public Gallery(String name, int size, String key,LocalDateTime uploadDate) {
        this.name = name;
        this.size = size;
        this.key = key;
        this.uploadDate = uploadDate;
    }
    public Gallery(String name, int size, String key, String keySmall,LocalDateTime uploadDate) {
        this.name = name;
        this.size = size;
        this.key = key;
