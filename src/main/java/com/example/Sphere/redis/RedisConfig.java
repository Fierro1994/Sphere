package com.example.Sphere.redis;
...
@Configuration
@EnableRedisRepositories(keyspaceConfiguration = RedisConfig.RedisRefreshTokenKeySpaceConfig.class,
...
public class RedisConfig {
    ...
    public class RedisRefreshTokenKeySpaceConfig extends KeyspaceConfiguration {
        ...
        protected Iterable<KeyspaceSettings> initialConfiguration() {
            ...
            settings.setTimeToLive(refreshExp.getSeconds());
