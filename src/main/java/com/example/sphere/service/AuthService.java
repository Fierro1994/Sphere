...
//        }
    ...
    public ResponseEntity<SimpleResponse> logout(LogoutRequest logoutRequest) {
        User user = userRepository.findById(logoutRequest.getId()).orElseThrow(()-> new EntityNotFoundException("User not found"));
